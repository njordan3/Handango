        ...
        switch (type) {
            ...
            case "forgot-password":
                ...
                message = {
                    ...
                    html: `Hello ${row.fname},<br>Click <a href="${link3}">here</a> to change your password.<br>If you did not request this link, then you may want to change your email address on your dashboard.<br>This link expires in 1 hour.`
                }
                break;
            case "forgot-email":
                message = {
