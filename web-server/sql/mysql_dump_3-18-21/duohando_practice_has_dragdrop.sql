...
CREATE TABLE `practice_has_dragdrop` (
  ...
  CONSTRAINT `fk_dd_id` FOREIGN KEY (`dragdrop_id`) REFERENCES `dragdrop` (`id`),
  CONSTRAINT `fk_dd_practice_id` FOREIGN KEY (`practice_id`) REFERENCES `practice` (`id`) ON DELETE CASCADE ON UPDATE RESTRICT
